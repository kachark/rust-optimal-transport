...
fn emd_integration_test() {
    ...
    let truth = array![[0.02875604, 0.        , 0.        , 0.        , 0.        ],
...
fn sinkhorn_integration_test() {
    ...
    let truth = array![[0.0512074 , 0.03423693, 0.01658163, 0.03622176, 0.06175227],
                        [0.03235553, 0.04322355, 0.06219694, 0.03188512, 0.03033886],
                        [0.03794162, 0.04216102, 0.04534867, 0.03822873, 0.03631996],
                        [0.04068612, 0.04108518, 0.03800087, 0.04044545, 0.03978238],
                        [0.03780933, 0.03929332, 0.03787189, 0.05321894, 0.03180652]];
...
// TODO: greenkhorn is unstable for small regularization values
#[test]
fn greenkhorn_integration_test() {
    ...
    let truth = array![[0.05553532, 0.05473157, 0.0475888 , 0.0197709 , 0.02237341],
...
fn unbalanced_sinkhorn_integration_test() {
    ...
    let truth = array![[5.12755466e-02, 2.53950152e-02, 3.90657040e-03, 1.84359745e-04, 3.63935236e-06],
                        [4.39939919e-02, 7.60500758e-02, 4.08333425e-02, 6.72594758e-03, 4.63425137e-04],
                        [1.25388468e-02, 7.56540148e-02, 1.41780127e-01, 8.15120868e-02, 1.96027149e-02],
                        [9.45281829e-04, 1.99069074e-02, 1.30213280e-01, 2.61294358e-01, 2.19327125e-01],
                        [2.37871304e-05, 1.74844768e-03, 3.99183176e-02, 2.79585782e-01, 8.19116169e-01]];
